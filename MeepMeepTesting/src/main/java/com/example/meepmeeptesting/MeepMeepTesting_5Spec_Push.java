...
public class MeepMeepTesting_5Spec_Push {
    public static void main(String[] args) {
        ...
        AccelConstraint accFastMax = new ProfileAccelConstraint(-90, 90);
...
//                        Math.toRadians(60), velMedium, accMedium)  // TODO 37
                ...
                .splineToLinearHeading(new Pose2d(47, -50, Math.toRadians(-90)), Math.toRadians(-90), velMedium, accMedium)

                .splineToLinearHeading(new Pose2d(54, -12, Math.toRadians(-90)), Math.toRadians(-60), velMedium, accMedium)

                .splineToLinearHeading(new Pose2d(57, -50, Math.toRadians(-90)), Math.toRadians(-90), velMedium, accMedium)

                .splineToLinearHeading(new Pose2d(62, -12, Math.toRadians(-90)), Math.toRadians(-60), velMedium, accMedium)

                .splineToLinearHeading(new Pose2d(62, -50, Math.toRadians(-90)), Math.toRadians(-90), velMedium, accMedium)
...
//                .strafeTo(new Vector2d(62, -8), velFast, accMedium)   //toward Sample6
                ...
                .splineToLinearHeading(new Pose2d(57, -63.5, Math.toRadians(-90)), Math.toRadians(-90), velFast, accMedium)
...
////                .splineToConstantHeading(new Vector2d(3,-35.5),Math.toRadians(90), velFast, accMedium)  //straighten out robot with another spline to submersible
          //      .splineToLinearHeading(new Vector2d(3,-35),Math.toRadians(90), velFast, accMedium)    //straighten out robot with another spline to submersible
...
//
//                                .strafeTo(new Vector2d(3, -34), velFast, accMedium)
//                /** Collect Spec2 */
//                /**********************TO BE TESTED*/
...
//                /** Score Spec2 */
                .strafeTo(new Vector2d(-1, -34), velFast, accMedium)
...
//                /** Score Spec3 */
                .strafeTo(new Vector2d(-5, -34), velFast, accMedium)
                .setReversed(true)                                                          //need this as robot is moving backward
...
//                .splineToConstantHeading(new Vector2d(40,-63),Math.toRadians(-90))
//                .splineToConstantHeading(new Vector2d(40,-63.5),Math.toRadians(-90))
                .strafeTo(new Vector2d(38, -62.5), velFast, accMedium)
                .strafeTo(new Vector2d(38, -64.5), velFast, accMedium)
//                // starting pose Y = -63, so need to go back more to wall, so -63.5?  TODO: need to reset Y as "wall squaring method"
//
////-----------cycle 4 to score Specimen4
//                /** Score Spec4 */
                .strafeTo(new Vector2d(-9, -34), velFast, accMedium)
//                .setReversed(true)
...
//                        Math.toRadians(-45), velFast, accFast)  //1st move back from submersible pole
            ...
            //    .splineTo(new Vector2d(-47.5, -60.5), Math.toRadians(-180), velFast, accFast)
             ...
             //   .strafeToLinearHeading(new Vector2d(-47.5, -60.5), Math.toRadians(0), velFast, accFast)
                .strafeToLinearHeading(new Vector2d(20, -60.5), Math.toRadians(0), velFast, accFast)
//
                .strafeToLinearHeading(new Vector2d(-47.5, -60.5), Math.toRadians(0), velFast, accFastMax)
//                .splineToLinearHeading(new Pose2d(35, -61.5, Math.toRadians(0)), Math.toRadians(0), velFast, accMedium)
//                .setReversed(true)
//
//                .splineToLinearHeading(new Pose2d(-48, -61.5, Math.toRadians(0)), Math.toRadians(0), velFast, accMedium)
