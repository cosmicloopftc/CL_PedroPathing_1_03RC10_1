...
public class RR_2AutoRedSpecimen_5SpecPush extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder combine_preloadMove_BackPush2SpecToHome_CollectSpec1 = preloadScore.endTrajectory().fresh()
                ...
                .afterTime(0.1, autoOuttakeArmAxonAction(wallPickup_OuttakeArmAxonPos, 0))            //TODO: rotate outtake arm to ready position to grab specimen on wall
                .afterTime(0.1, autoouttakeExtensionAction(wallPickup_OuttakeExtensionPos))                       //TODO: extend out arm out (need to this to the place after preloadscore
                .afterTime(0.1, autoOuttakeSliderAction(wallPickup_SliderPos, 1))                      //TODO: ?outtake slider position to pickup specimen from wall
...
//                .afterTime(9.5, autoOuttakeArmAxonAction(scoring_OuttakeArmAxon_ScoringPos,0))    //rotate to specimen score position
                ...
                .setReversed(false)
//                .splineToLinearHeading(new Pose2d(41.5,-37, Math.toRadians(-90)),      // used to be (40, -37)   //pushSample6Home, midway by Spline
//                        Math.toRadians(60), velMediumMax, accMedium)  // TODO 40, -37
          //      .waitSeconds(0.5)

                .strafeTo(new Vector2d(35, -41), velMediumMax, accMedium)
                //       .setReversed(true)
...
//                .strafeTo(new Vector2d(62, -8), velFast, accMedium)   //toward Sample6
                ...
                .splineToLinearHeading(new Pose2d(45, -65, Math.toRadians(-90)), Math.toRadians(-90), velMedium, accMedium)
...
//            autoRobot.Intake.intakeSlides.setMode(DcMotorEx.RunMode.RUN_USING_ENCODER);
