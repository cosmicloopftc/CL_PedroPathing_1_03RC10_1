...
//                .afterTime(9.5, autoOuttakeArmAxonAction(scoring_OuttakeArmAxon_ScoringPos,0))    //rotate to specimen score position
  ...
  //              .strafeToSplineHeading(new Vector2d(40, -32), Math.toRadians(-90), velMedium, accMedium)
                ...
                //       .setReversed(true)
                .splineToLinearHeading(new Pose2d(48, -15, Math.toRadians(-90)), Math.toRadians(-60), velMedium, accMedium)
                               // prev went to -47
                .splineToLinearHeading(new Pose2d(48, -47, Math.toRadians(-90)), Math.toRadians(-90), velFastMin, accMedium)  //velFastMin accFastMax

                .splineToLinearHeading(new Pose2d(57, -15, Math.toRadians(-90)), Math.toRadians(-60), velMedium, accMedium)   // accFastMin

                .splineToLinearHeading(new Pose2d(56, -47, Math.toRadians(-90)), Math.toRadians(-90), velFastMin, accMedium)  //velFastMin accFastMax

                .splineToLinearHeading(new Pose2d(64, -15, Math.toRadians(-90)), Math.toRadians(-60), velMedium, accMedium)  // accFastMin

                .splineToLinearHeading(new Pose2d(65, -47, Math.toRadians(-90)), Math.toRadians(-90), velFastMin, accMedium)   //velFastMin accFastMax
...
//                .strafeToLinearHeading(new Vector2d(20, -60.5), Math.toRadians(0), velFast, accMedium);
                ...
                .setTangent(45)                   // prev 48, -52
                .strafeToLinearHeading(new Vector2d(15, -49), Math.toRadians(0), new TranslationalVelConstraint(85), new ProfileAccelConstraint(-80, 80))
                ...
                .strafeToLinearHeading(new Vector2d(-56.5, -55.5), Math.toRadians(0), new TranslationalVelConstraint(85), new ProfileAccelConstraint(-80, 80))
                                // prev -57.5, -52.5
...
//
                ...
                .afterTime(0.1, autoOuttakeArmAxonAction(wallPickup_OuttakeArmAxonPos, 0))    //rotate outtake arm to ready position to grab specimen on wall
                .afterTime(0.1, autoouttakeExtensionAction(wallPickup_OuttakeExtensionPos))        //extend out arm out to grab specimen on wall
                .afterTime(0.1, autoOuttakeSliderAction(wallPickup_SliderPos, 1));
