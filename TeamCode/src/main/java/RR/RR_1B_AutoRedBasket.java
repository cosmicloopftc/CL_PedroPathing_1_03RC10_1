...
//                        autoResetBothSliders(18) ,  //for entire 30 second auto
                        ...
                        new SequentialAction(
                                ...
                                autoIntakeSliderAction(240, sliderPower-0.3, 0),
                                ...
                                autoIntakeSliderAction(260, sliderPower-0.3, 0),
                                autoIntakeServoAxonAction(intakeAxonPosition, 0),
                                /*NEXT STEP*/
                                autoIntakeSliderAction(1, sliderPower, 0),
                                ...
                                new ParallelAction(
                                        autoOuttakeSliderAction(0, 1),
                                        autoIntakeSliderAction(160, sliderPower, 0),
                                        //move to first sample
                                        grabPose3.build()
                                ),
                                ...
                                new ParallelAction(
                                        ...
                                        new SequentialAction(
                                                ...
                                                AutoIntakeSweeperAction(sweeperOUT, 2.5),
                ...
                new ParallelAction(
                        ...
                        new SequentialAction(
                                new ParallelAction(
                                        ...
                                        new SequentialAction(
                                                autoIntakeSpiner(-1, 0),
                                                autoIntakeServoAxonAction(intakeDown, 0.5),
                                                autoIntakeSliderAction(110, 0.4, 0),
                                                autoIntakeSliderAction(330, 0.3, 0)
                                        )
                                ),
                                //Move to basket
                                autoIntakeSpiner(-1, 0.1),
