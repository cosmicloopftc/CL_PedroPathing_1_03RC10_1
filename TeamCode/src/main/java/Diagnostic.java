...
@TeleOp(group="Primary", name= "Diagnostic v1")
public class Diagnostic extends OpMode {
    ...
    private final String[] DriveTrainMotorNames = {"leftFront", "rightFront", "leftRear", "rightRear"};
...
//        }
    ...
    public void loop() {
        ...
        switch (state) {
            case 0:
                telemetry.addData("Press Button for Diagnostic ", "Right Bumper for Help \"X: Intake Servo | Y: Outtake Servo | A: Drivetrain Test\"");
            ...
            case 2:
                ...
                if (elapsedTime >= DELAY_TIME) {
                    ...
                    telemetry.addData("Measured Position", axonServos[currentServo].getPosition());
                    timer.reset();
                    state++;
                }
                break;
            ...
            case 6:
                axonServos[currentServo].setPosition(0.42);
                if (elapsedTime >= DELAY_TIME) {
                    telemetry.addData("Inside position", "0.42");
                    telemetry.addData("Measured Position", axonServos[currentServo].getPosition());
                    timer.reset();
                    state++;
                }
