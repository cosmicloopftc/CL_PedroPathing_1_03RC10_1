...
//                telemetryA.addData("Outtake left slide Position: ",robot.Outtake.outtakeLeftSlide.getCurrentPosition());
                ...
                if (robot.Outtake.outtakeLeftSlide.getCurrentPosition() > 1100 && robot.Outtake.outtakeLeftSlide.getCurrentPosition() < 1300 && (gamepad2.left_bumper)){ // Open claw if specimen scored
                    robot.Outtake.openClaw();
                }
                ...
                if (robot.Outtake.outtakeLeftSlide.getCurrentPosition() > 1400 && robot.Outtake.outtakeLeftSlide.getCurrentPosition() < 1800 && gamepad2.left_bumper){ // If at high chamber finish position
                    robot.Outtake.openClaw();
                }
                else if (robot.Outtake.outtakeLeftSlide.getCurrentPosition() > 1400 && robot.Outtake.outtakeLeftSlide.getCurrentPosition() < 1800 && robot.Outtake.claw.getPosition() < 0.05 && gamepad2.a){ // Only if at high Chamber finish position and claw is open
                    state = State.READY_DOWN;
                }
                else if (robot.Outtake.outtakeLeftSlide.getCurrentPosition() > 1400 && robot.Outtake.outtakeLeftSlide.getCurrentPosition() < 1800 && robot.Outtake.claw.getPosition() < 0.05 && gamepad2.dpad_down){ // Only if at high Chamber finish position and claw is open
                    outtakeOption = "wallIntakeFront";
                }
                if (gamepad1.y)
                {
