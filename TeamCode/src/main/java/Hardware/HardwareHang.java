...
//example:  map and setup mode of Intake motor
        ...
        hangMotor.setDirection(DcMotor.Direction.FORWARD); // Forward if 0 is at ready to hang position, reverse if 0 inside robot
...
//public method (function) for Intake motor power--to be accessible from anywhere
    ...
    public void hang() {
        setPowerPosition(5, 0.1); //Try 2500 or 3000
    }
}